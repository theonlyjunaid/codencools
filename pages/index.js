      ...
      <div className='bg-gray-300'>
        <header className="bg-gray-300 text-gray-600 body-font mb-7 md:mb-10 border-b-2 border-blue-600">
          <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <button className="text-white inline-flex items-center bg-blue-500 hover:bg-blue-700 border-0 py-1 px-3 focus:outline-none rounded text-base mt-4 md:mt-0">Button
